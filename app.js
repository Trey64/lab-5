...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var sumMsg = a + ' and ' + b + ' and ' + c + ' sum to ' + sum1 + '.';
  var productMsg = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + product1 + '.';
  return [sum1, product1, sumMsg, productMsg];
}
...
function sumArray(testArray){ //eslint-disable-line
  var sum2 = sum(sum(testArray[0], testArray[1])[0], testArray[2])[0];
  var arrayMsg = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + sum2 + ' is their sum.';
  return [sum2, arrayMsg];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var arrayMsg = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of 24.';
  return [product2, arrayMsg];
}
